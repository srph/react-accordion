...
var AccordionButton = function (_Component) {
  _inherits(AccordionButton, _Component);
  ...
  function AccordionButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AccordionButton.__proto__ || Object.getPrototypeOf(AccordionButton)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
      _this.context.accordion.onOpen(_this.context.accordion.index);
  ...
  _createClass(AccordionButton, [{
    ...
    value: function render() {
      var active = this.context.accordion.active === this.context.accordion.index;

      return _react2.default.createElement(
        'button',
        _extends({}, this.props, { type: 'button', onClick: this.handleClick }),
...
AccordionButton.contextTypes = {
  accordion: _propTypes2.default.object
};
...
var AccordionPane = function (_Component) {
  _inherits(AccordionPane, _Component);

  function AccordionPane() {
    _classCallCheck(this, AccordionPane);

    return _possibleConstructorReturn(this, (AccordionPane.__proto__ || Object.getPrototypeOf(AccordionPane)).apply(this, arguments));
  }

  _createClass(AccordionPane, [{
    key: 'getChildContext',
    value: function getChildContext() {
      return {
        accordion: _extends({}, this.context.accordion, {
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', _extends({}, props, { className: (0, _classnames2.default)(accordion.paneClassName, _defineProperty({}, accordion.openClassName, accordion.active === index)) }));
    }
  }]);
...
var _AccordionPane = __webpack_require__(13);

var _AccordionPane2 = _interopRequireDefault(_AccordionPane);

var _AccordionButton = __webpack_require__(12);

var _AccordionButton2 = _interopRequireDefault(_AccordionButton);
...
var Accordion = function (_Component) {
  ...
  function Accordion() {
    ...
    }, _this.handleOpen = function (index) {
      _this.setState({ active: _this.state.active === index ? -1 : index });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Accordion, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['paneClassName', 'openClassName', 'defaultActive', 'component']);
...
Accordion.Pane = _AccordionPane2.default;
Accordion.Button = _AccordionButton2.default;
...
Object.defineProperty(exports, 'AccordionButton', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_AccordionButton).default;
  }
});

var _AccordionPane = __webpack_require__(13);

Object.defineProperty(exports, 'AccordionPane', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_AccordionPane).default;
  }
});
